/**
 *Copyright 2015 Al_St0janN *Modifications (including forks) of the code to fit personal needs are allowed only for personal use and should refer back to the original source.
...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://raw.githubusercontent.com/stojann/ST-ARMY/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        chatLink: "https://raw.githubusercontent.com/stojann/ST-ARMY/master/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            themeLink: null,
            fbLink: "https://www.facebook.com/SrpskiTutorijali?ref=ts&fref=ts" "https://www.facebook.com/kovalskaa?fref=ts" ,
            youtubeLink: "https://www.youtube.com/user/SrpskiTutoriali" "https://www.youtube.com/user/kovalskaa" ,
            website: null,
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,
            ...
            fbCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.fbLink === "https://www.facebook.com/SrpskiTutorijali?ref=ts&fref=ts")
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was made by ' Al_St0janN '.');
                    }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.themeLink === "string")
                            API.sendChat(subChat(basicBot.chat.genres, {link: All Genres}));
                    }
                }
            },
